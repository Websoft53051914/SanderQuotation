...
請針對每一筆資料，依不同欄位進行關鍵字提取，並輸出 TBSanderModuleItemKeywordDM 結構。
...
目標：提取「廠商料號（MPN）」與「品牌（Manufacturer）」
...
4. 輸出格式（重要）：
   ...
   - 全部大寫
   - 範例：
     RESISTOR 10KOHM 0603 1%
     CAPACITOR 1000UF 25V 105C ELECTROLYTIC DIP

5. 每個欄位（Description / Description2）只輸出一筆 Keyword
