...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventClick: function (info) {
            ...
            var tempS = formatDateNew(st_date);
            var tempE = formatDateNew(ed_date);

            var r_date = ed_date == null ? formatDateNew((st_date)) : formatDateNew((st_date)) + ' to ' + formatDateNew((updateDay));
            var er_date = ed_date == null ? formatDateNew((st_date)) : formatDateNew((st_date)) + ' to ' + formatDateNew((updateDay));
            ...
            if (gt_time == ed_time || selectedEvent.end == null) {
                document.getElementById('event-time').setAttribute("hidden", true);
